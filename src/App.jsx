...
function CaseMod(){
  ...
  <div style={{maxWidth:720,margin:"0 auto",padding:"20px 16px 40px"}}>
    ...
    {vw==="actions"&&<ActList items={acts} onEdit={c=>{sE(c);sM(true)}} onCompleteAction={completeAction}/>}
  ...
  <Md open={mo} onClose={()=>{sM(false);sE(null)}}><CaseForm key={ed?.id||"new"} init={ed} onSave={save} onCancel={()=>{sM(false);sE(null)}} opts={opts}/></Md>
